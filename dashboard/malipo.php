                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="setting-input-1" class="form-label">Mkoa Uliopo<span class="text-danger">*</span></label>
                                            <select class="form-select ">
                                                <option value=""></option>
                                                <option value="">Chagua Mkoa uliopo...</option>
                                                <option value="option-1">Mwanza</option>
                                                <option value="option-1">Dodoma</option>
                                                <option value="option-1">Dar</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="setting-input-1" class="form-label">Wilaya Uliyopo<span class="text-danger">*</span></label>
                                            <select class="form-select ">
                                                <option value=""></option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="setting-input-1" class="form-label">Mahali pakupolea <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="setting-input-1" value="" placeholder="pakupokelea mzigo" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="setting-input-1" class="form-label">Simu ya Mpokeaji <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="setting-input-1" value="" placeholder="+255..." required="">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <form action="">
                                <div class="d-flex justify-content-end p-3">
                                    <a href="payed.php" class="btn app-btn-secondary">Lipia Hapa</a>
                                </div>
                            </form>
                        </div>
